...
local Divine_Chance = 0.0001
local Mythical_Chance =  50.001 
local Legendary_Chance =  0.01 
local Rare_Chance = 0.1
local Uncommon_Chance =  1
local Common_Chance = 3
...
local Mythical_Reward = {
	...
	["ArgivyGems"] = { Priority ="Artifact",Rate_Drop = 20, Item_Class = "Gems" } 
...
function module:Random_Drop(Mob_Property)
	...
	--print(CheckedCommon , CheckedUncommon , CheckedRare , CheckedLegendary , CheckedMythical , CheckedDivine)
